...
export default function TheirStory() {
  return (
    <main className="relative min-h-screen bg-[#FFF9F6] text-gray-800 font-sans overflow-hidden flex flex-col justify-center items-center">
      {/* --- Decorative India Gate --- */}
      <img
        src={`${import.meta.env.BASE_URL}indiagate.png`}
        alt="India Gate"
        className="absolute bottom-[6%] left-[5%] w-[140px] sm:w-[200px] md:w-[250px] opacity-90 pointer-events-none select-none"
      />

      {/* --- Paper Note (pinned, tilted) --- */}
      <img
        src={`${import.meta.env.BASE_URL}paper-note.png`}
        alt="VFilms Note"
        className="absolute top-[12%] left-[10%] w-[260px] sm:w-[340px] md:w-[400px] lg:w-[460px]
        rotate-[-6deg] drop-shadow-[0_14px_22px_rgba(0,0,0,0.25)] animate-float"
      />

      {/* --- Team Section --- */}
      <section className="relative flex flex-col items-center justify-center text-center mt-40 md:mt-60">
        {/* Silhouettes */}
      ...
      <div className="text-center mt-16 z-20">
        <h3 className="font-display text-[20px] sm:text-[24px] md:text-[28px] text-brand-navy mb-4">
